            ...
            <div class="col-lg-7 col-md-6">
              <form action="{{ route('orders.store') }}" method="POST">
                      ...
                      <div class="col-lg-6 col-12 mb-4">
                        <div class="card card-body p-6">
                          <div class="form-check mb-4">
                            <input class="form-check-input delivery-address" type="radio" value="{{ $address->id }}"
                              name="address_id" id="homeRadio" {{ $address->is_primary ? 'checked' : '' }}>
                ...
                <div class="mt-3">
                  ...
                  <ul class="list-group list-group-flush available-services" style="display: none">
                  </ul>
                </div>
